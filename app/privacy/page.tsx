export default function PrivacyPage() {
  return (
    <main className="max-w-3xl mx-auto p-6">
      ...
      <p>본 서비스는 이용자의 개인정보를 직접 수집하거나 이용하지 않습니다.</p>

      <h2>제2조(처리하는 개인정보 항목)</h2>
      <p>본 서비스는 개인정보를 수집하거나 저장하지 않습니다.</p>

      <h2>제3조(개인정보의 보유 및 이용기간)</h2>
      <p>개인정보를 수집하지 않으므로 별도의 보유기간이 없습니다.</p>
      ...
      <p>
      본 서비스는 서비스 제공을 위하여 Vercel Inc.의 호스팅 서비스를 이용하고 있습니다.
      서비스 운영 과정에서 접속 기록 등 최소한의 기술적 정보가 호스팅 사업자에 의해 처리될 수 있습니다.
      </p>
