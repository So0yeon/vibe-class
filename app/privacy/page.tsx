export default function PrivacyPage() {
  return (
    ...
    <h2 className="mt-8 mb-2 text-xl font-semibold">
      ...
      <p>
        본 서비스는 이용자의 개인정보를 직접 수집하거나 보유하지 않습니다.
      </p>

      <p className="mt-3">
        다만 서비스 운영 과정에서 발생할 수 있는 기술적 정보를 보호하기
        위하여 신뢰할 수 있는 호스팅 사업자(Vercel Inc.)를 이용하고 있으며,
        HTTPS 기반의 보안 통신 환경을 제공하고 있습니다.
      </p>

      <p className="mt-3">
        본 서비스는 개인정보를 수집하지 않으므로 개인정보 보호법상 별도의
        개인정보 저장·관리 조치를 적용하지 않습니다.
      </p>
    ...
    <p>
      ...
      따라서 법정대리인의 동의가 필요한 개인정보 수집 및 이용 절차를
      운영하지 않습니다.
    </p>
